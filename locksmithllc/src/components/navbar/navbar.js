...
const Navbar = () => {
    return (
        ...
        <div className="flex justify-end text-lg flex-1 space-x-4 py-2">
          ...
          <a href="#services" className="border-[0.5px] font-bold rounded-xl text-[#fbd8a0] text-sm hover:text-white hover:border-[#fbd8a0] hover:ease-in-out duration-300 ml-12 p-[6px] opacity-[80%]">24 Hour Locksmiths</a>
        </div>
      </nav>
    );
};
